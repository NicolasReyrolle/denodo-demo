...
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'Engine power (KW)' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'immatriculations_first_load', @level2type=N'COLUMN',@level2name=N'PKW'
GO
